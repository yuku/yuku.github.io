...
<p>実装としては <a href="https://github.com/n6g7/ipynb-loader">ipynb-loader</a> が内部で行っていたことを Python を使わずに Node.js だけでやる、というのが基本的な内容です。以前の実装については <EntryLink id="blog/2019/01/hello-ipynb" /> を参照してください。</p>
